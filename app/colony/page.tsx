...
const WAITLIST_URL = 'https://mycolonyhq.com/sign-up'
    ...
    <div className="min-h-screen bg-[#0C0C0E] font-dm-sans text-[#F2F0ED] overflow-x-hidden">
      ...
      <nav className="fixed top-0 left-0 right-0 z-50 px-10 py-5 flex items-center justify-between backdrop-blur-[20px] bg-[rgba(12,12,14,0.8)] border-b border-white/[0.06] max-md:px-5 max-md:py-4">
        ...
        <ul className="flex items-center gap-8 list-none max-md:hidden">
          ...
          <li>
            <a
              href={WAITLIST_URL}
              className="bg-[#E8993E] text-[#0C0C0E] px-6 py-2.5 rounded-[10px] text-sm font-semibold no-underline hover:translate-y-[-1px] hover:shadow-[0_4px_20px_rgba(232,153,62,0.3)] transition-all duration-200"
            >
              Join Waitlist
            </a>
          </li>
      ...
      <section className="min-h-screen flex flex-col items-center justify-center text-center px-6 pt-[140px] pb-20 relative max-md:pt-[120px] max-md:pb-[60px]">
        ...
        <div className="colony-fade-up-3 flex gap-4 items-center max-md:flex-col max-md:w-full">
          <a
            href={WAITLIST_URL}
            className="bg-[#E8993E] text-[#0C0C0E] px-9 py-4 rounded-xl text-base font-semibold no-underline hover:translate-y-[-2px] hover:shadow-[0_8px_30px_rgba(232,153,62,0.3)] transition-all duration-200 max-md:w-full max-md:text-center"
          >
            Join the Waitlist
          </a>
          <a
      ...
      <section
        id="how-it-works"
        className="py-[120px] px-6 max-w-[1100px] mx-auto"
      >
        <div className="text-[13px] uppercase tracking-[0.12em] text-[#E8993E] font-semibold mb-4">
          How It Works
        </div>
          ...
          <div className="relative max-w-[640px]">
            ...
            <div className="flex flex-col gap-4 mb-10">
              <div className="flex gap-4 items-start p-5 rounded-[14px] bg-[#1A1A1E] border border-white/[0.06]">
                <div className="text-[#34C759] text-lg shrink-0 mt-0.5">
                  &#9673;
                </div>
                <div>
      ...
      <section id="pricing" className="py-[120px] px-6 max-w-[1100px] mx-auto text-center">
        <div className="max-w-[560px] mx-auto">
          ...
          <a
            href={WAITLIST_URL}
            className="inline-block bg-[#E8993E] text-[#0C0C0E] px-9 py-4 rounded-xl text-base font-semibold no-underline hover:translate-y-[-2px] hover:shadow-[0_8px_30px_rgba(232,153,62,0.3)] transition-all duration-200"
          >
            Join the Waitlist
          </a>
